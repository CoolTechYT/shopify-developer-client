      ...
      <div className="container">
        <div className={innerClasses}>
          ...
          <div style={{ margin: "24px 64px", marginBottom: 128, textAlign: `left` }}>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at https://turbovid.io, unless otherwise defined in this Privacy Policy.</p>
